...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in books_database/books_database_pb2_grpc.py depends on'
...
class BooksDatabaseStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Prepare = channel.unary_unary(
                ...
                request_serializer=books__database_dot_books__database__pb2.PrepareRequest.SerializeToString,
        ...
        self.Commit = channel.unary_unary(
                ...
                request_serializer=books__database_dot_books__database__pb2.CommitRequest.SerializeToString,
        ...
        self.Abort = channel.unary_unary(
                ...
                request_serializer=books__database_dot_books__database__pb2.AbortRequest.SerializeToString,
...
def add_BooksDatabaseServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Prepare': grpc.unary_unary_rpc_method_handler(
                    servicer.Prepare,
                    request_deserializer=books__database_dot_books__database__pb2.PrepareRequest.FromString,
                    response_serializer=books__database_dot_books__database__pb2.PrepareResponse.SerializeToString,
            ),
            'Commit': grpc.unary_unary_rpc_method_handler(
                    servicer.Commit,
                    request_deserializer=books__database_dot_books__database__pb2.CommitRequest.FromString,
                    response_serializer=books__database_dot_books__database__pb2.CommitResponse.SerializeToString,
            ),
            'Abort': grpc.unary_unary_rpc_method_handler(
                    servicer.Abort,
                    request_deserializer=books__database_dot_books__database__pb2.AbortRequest.FromString,
...
class BooksDatabase(object):
    ...
    def Prepare(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/books_database.BooksDatabase/Prepare',
            books__database_dot_books__database__pb2.PrepareRequest.SerializeToString,
    ...
    def Commit(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/books_database.BooksDatabase/Commit',
            books__database_dot_books__database__pb2.CommitRequest.SerializeToString,
    ...
    def Abort(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/books_database.BooksDatabase/Abort',
            books__database_dot_books__database__pb2.AbortRequest.SerializeToString,
